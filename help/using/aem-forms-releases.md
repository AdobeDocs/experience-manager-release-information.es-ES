...
Adobe Experience Manager [!DNL Forms] es una aplicación implementada en AEM. Amplía las atractivas experiencias web y móviles a formularios y documentos empresariales, lo que permite a las organizaciones completar interacciones digitales complejas a la vez que mejora las experiencias de los usuarios y aumenta el alcance comercial. AEM [!DNL Forms]AEM , integrado, se incluye con Inicio rápido, pero tiene un conjunto limitado de funcionalidades. El paquete de complementos AEM [!DNL Forms] proporciona funciones avanzadas como la integración con [!DNL Adobe Analytics], [!DNL Adobe Sign], servicios de documentos, motor de flujos de trabajo y mucho más.

>[!NOTE]
>
>
>La funcionalidad Formularios adaptables, disponible en [AEM 6.5 Inicio rápido](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/implementing/deploying/deploying/deploy), está diseñada únicamente para la exploración y la evaluación. Para su uso en producción, es esencial obtener una licencia válida para AEM Forms, ya que la funcionalidad Formularios adaptables requiere una licencia adecuada.
...
<table>
  ...
  <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/release-notes#forms-6519"> (Solo AEM Forms en JEE) AEM 6.5 Forms Service Pack 19.1 (6.5.19.1)</a></td>
  ...
  <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/release-notes#forms-6519">Paquete de complementos del Service Pack 19 de AEM Forms para AEM 6.5.19.0</a></td>
    <td><a href="https://experienceleague.adobe.com/es/docs/experience-manager-65/content/release-notes/release-notes">AEM 6.5.19.0</a></td>
    <td>
     <ul>
     <br><b>Programas de instalación de parches para AEM Forms en OSGi</b></br>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/release-notes#forms-6518">Paquete de complementos del Service Pack 18 de AEM Forms para AEM 6.5.18.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/release-notes#forms-6517">Paquete de complementos del Service Pack 17 de AEM Forms para AEM 6.5.17.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-16#forms-6516">Paquete de complementos del Service Pack 16 de AEM Forms para AEM 6.5.16.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-15#forms-6515">Paquete de complementos del Service Pack 15 de AEM Forms para AEM 6.5.15.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-14#forms-6514">Paquete de complementos del Service Pack 14 de AEM Forms para AEM 6.5.14.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-13#forms-65130">Paquete de complementos del Service Pack 13 de AEM Forms para AEM 6.5.13.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-12#forms-65120">Paquete de complementos del Service Pack 12 de AEM Forms para AEM 6.5.12.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-11#forms-65110">Paquete de complementos del Service Pack 11 de AEM Forms para AEM 6.5.11.1</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-11#forms-65110">Paquete de complementos del Service Pack 11 de AEM Forms para AEM 6.5.11.0</a></td>
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-11">AEM 6.5.11.0</a></td>
    <td>
     <ul>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-10#forms-65100">Paquete de complementos del paquete de servicio 10 de AEM Forms para AEM 6.5.10.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-9#forms-6590">Paquete de complementos del paquete de servicio 9 de AEM Forms para AEM 6.5.9.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-8#forms-6580">Paquete de complementos del Service Pack 8 de AEM Forms para AEM 6.5.8.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-7#forms-6570">Paquete de complementos del Service Pack 7 de AEM Forms para AEM 6.5.7.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-6#forms-6560">Paquete de complementos del Service Pack 6 de AEM Forms para AEM 6.5.6.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-5#forms-6550">Paquete de complementos del Service Pack 5 de AEM Forms para AEM 6.5.5.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-4#forms-6540">Paquete de complementos del Service Pack 4 de AEM Forms para AEM 6.5.4.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-3#forms-6530">Paquete de complementos del Service Pack 3 de AEM Forms para AEM 6.5.3.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-2#forms-6520">Paquete de complementos del Service Pack 2 de AEM Forms para AEM 6.5.2.0</a></td>
   ...
   <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-1#forms">Paquete de complementos del Service Pack 1 de AEM Forms para AEM 6.5.1.0</a></td>
