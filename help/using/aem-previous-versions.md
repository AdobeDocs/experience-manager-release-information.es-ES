...
* Para necesidades de documentación organizativa más amplias, Adobe recomienda que el paquete se implemente en una instancia de autor de AEM accesible internamente y que no sea de producción.
...
|:-----------:|:--------------------------------------------------:|
| [!DNL Experience Manager] 6.4 | [Documentación de Adobe Experience Manager 6.4](https://experienceleague.adobe.com/es/docs/experience-manager-64) |
...
1. En un explorador web, introduzca la página de la documentación para abrirla. Usando el ejemplo de AEM 5.6.1, la URL sería: http://localhost:4502/libs/aem-docs/content/es/cq/5-6-1.html.
