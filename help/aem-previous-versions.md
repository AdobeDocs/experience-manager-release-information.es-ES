...
Las versiones de [!DNL Adobe Experience Manager], CQ y CRX que figuran en esta página han llegado al final de su vida útil y ya no son vendidas de manera oficial por parte de Adobe. Las últimas versiones de la documentación oficial de Adobe para estas versiones anteriores están disponibles para sus necesidades de autoayuda. Adobe recomienda actualizar a la última versión: [[!DNL Adobe Experience Manager] as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service.html?lang=es).

>[!NOTE]
>
>Para saber cuándo [!DNL Experience Manager] la versión llega al final de la asistencia principal, consulte [productos y períodos de asistencia técnica](https://helpx.adobe.com/es/support/programs/eol-matrix.html) y buscar `AEM`.

### Antes de realizar la instalación {#before-installation}

Antes de descargar el paquete, determine quién consumirá el contenido. Esta decisión determina cómo se implementa:
...
* Si no tiene un Adobe ID, puede crearlo en https://www.adobe.com/ Si necesita ayuda para crear o administrar su Adobe ID, [consulte esta guía](https://helpx.adobe.com/es/manage-account.html)
...
Para instalar un paquete de documentación heredada, debe tener [!DNL Experience Manager] instalado y en ejecución en la unidad local o de red.
...
1. Seleccione el **[!UICONTROL Descargar]** botón.

1. Este es un ejemplo de lo que ve:
...
>[!NOTE]
>
>Para AEM 6.2, inicie la instancia local con un tamaño máximo de pila aumentado, utilizando este comando, por ejemplo: ` java -jar -XX:MaxPermSize=2048m aem-author.jar`
...
1. Una vez cargado el paquete, lo instala.

1. En la interfaz de usuario del administrador de paquetes, busque el paquete y seleccione **[!UICONTROL Instalar]**.

1. En el cuadro de diálogo de confirmación, seleccione **[!UICONTROL Instalar]** de nuevo. La instalación tarda unos minutos.
...
Si tiene preguntas sobre el uso de Experience Manager, Adobe recomienda que [póngase en contacto con expertos de la comunidad experimentados en la [!DNL Experience Manager] foros](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community).
